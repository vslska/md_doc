...
>Docker — это не магия, а **удобный враппер** над стандартными примитивами Linux (cgroups + namespaces), упакованный в единый рабочий процесс: `Dockerfile → Image → Registry → Container`.
