...
Когда сталкиваетесь с ошибкой "dpkg заблокирован другим процессом", это означает, что какой-то процесс уже использует системные файлы блокировки, предотвращая одновременное выполнение других операций с пакетами.
